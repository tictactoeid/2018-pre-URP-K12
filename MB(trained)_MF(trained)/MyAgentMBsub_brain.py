...
class Brain:
        ...
        def predictOne(self, s):
                ...
                return self.predict(s.reshape(1,2)).flatten()
...
class Agent:
        ...
        # ============================================
        def Load(self, num):
                self.brain.model = keras.models.load_model("./10M_MB/testModel_MBSub{}".format(num))
                with open("./10M_MB/testModel_MBSub{}.steps".format(num),"r") as f:
                        self.steps = int(f.read())
                        print(self.steps)
                with open("./10M_MB/testModel_MBSub{}.exp".format(num),"rb") as f:
		...
		#print 1111
			...
			#print "rand"
                        ...
                        return self.brain.predictOne(numpy.array([s[2],s[0]]))
