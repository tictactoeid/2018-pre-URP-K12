...
class Agent:
        ...
        # ============================================
        def Load(self, num):
                self.brain.model = keras.models.load_model("./10M_MF/testModel{}".format(num))
                with open("./10M_MF/testModel{}.steps".format(num),"r") as f:
                        self.steps = int(f.read())
                        print(self.steps)
                #with open("./10M_MF/testModel{}.exp".format(num),"rb") as f:
