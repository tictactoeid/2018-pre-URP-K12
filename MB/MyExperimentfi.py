...
# ==========================================================================================
import MyPongfi # My PyGame Pong Game 
import MyAgentfi # My DQN Based Agent
import MyAgent2fi # My DQN Based Agent
import numpy as np 
import random 
import matplotlib.pyplot as plt
import MyAgentfisub_brain
import csv
...
# =======================================================================
# Normalise GameState
TheAgentsub = MyAgentfisub_brain.Agent(2, 1)
def CaptureNormalisedState(PlayerYPos, BallXPos, BallYPos, BallXDirection, BallYDirection, BallSpeed):
	...
	gstate[5] = TheAgentsub.ballysub(gstate1)
...
def PlayExperiment():
        ...
        TheGame = MyPongfi.PongGame()
    # Initialise Game
        TheGame.InitialDisplay()
        #
        #  Create our Agent (including DQN based Brain)
        TheAgent1 = MyAgentfi.Agent(STATECOUNT+1, ACTIONS)
        #TheAgent1.Load(500)
	#TheAgentsub.Load(500)
        TheAgent2 = MyAgent2fi.Agent(STATECOUNT, ACTIONS)
        GameTime = 0
        ...
        #print our where wer are after saving where we are
			...
			TheAgentsub.Save(GameTime)
                ...
                if GameTime % 1200 == 0:
                        ...
                        print("Game Time: ", GameTime,"  Game Score1: ", "{0}".format(TheGame.Display_Score1),"  Game Score2: ", "{0}".format(TheGame.Display_Score2)," Recent Rate: ","{0}:{1}".format(s,MyPongfi.RECENT_SCORE-s) )
